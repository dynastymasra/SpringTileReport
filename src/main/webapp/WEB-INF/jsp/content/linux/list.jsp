...
<div class="jumbotron">
    <div class="alert alert-info">
        <h4>
            Linux Study Club List
            <div class="btn-group">
                <button type="button" class="btn btn-info dropdown-toggle" data-toggle="dropdown">
                    <span class="glyphicon glyphicon-download"></span> <span class="caret"></span>
                </button>
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<c:url value='ksl/report?format=pdf'/>">.pdf</a></li>
                    <li><a href="<c:url value='ksl/report?format=xls'/>">.xls</a></li>
                    <li><a href="<c:url value='ksl/report?format=csv'/>">.csv</a></li>
                    <li><a href="<c:url value='ksl/report?format=html'/>">.html</a></li>
                </ul>
            </div>
            <a href="<c:url value='/ksl/form'/>" class="pull-right"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></button></a>
        </h4>
    </div>
