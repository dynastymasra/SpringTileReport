        ...
        <h4>
            ...
            <div class="btn-group">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="<c:url value='ksw/report?format=pdf'/>">.pdf</a></li>
                    <li><a href="<c:url value='ksw/report?format=xls'/>">.xls</a></li>
                    <li><a href="<c:url value='ksw/report?format=csv'/>">.csv</a></li>
                    <li><a href="<c:url value='ksw/report?format=html'/>">.html</a></li>
                </ul>
            </div>
            <a href="<c:url value='/ksw/form'/>" class="pull-right"><button type="button" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span></button></a>
        </h4>
    </div>
